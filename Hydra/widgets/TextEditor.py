...
from Hydra.utils.completer_utility import wordList, funcList, errorList, tokenize
...
class Editor(QsciScintilla):
    ...
    def set_brace_colors(
        self, matched_B=None, matched_F=None, unmatched_B=None, unmatched_F=None
    ):
