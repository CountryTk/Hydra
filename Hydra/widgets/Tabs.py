...
from Hydra.widgets.Terminal import Terminal, Console
from Hydra.widgets.Directory import Directory
from Hydra.utils.config import config_reader
from Hydra.widgets.Events import Events
...
class Tabs(QWidget):
    def __init__(self, callback, app, palette, parent=None):
        ...
        self.directory = Directory(
            callback, self.app, self.palette
        )  # TODO: This is top left
        ...
        if (
            editor["tabShape"] is True
        ):  # If tab shape is true then they have this rounded look
