from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QCompleter, QShortcut, QPlainTextEdit, QStatusBar
...
class Content(QWidget):
    def __init__(self, text, fileName, baseName, themeIndex, parent, window):
        ...
        self.nigger.addWidget(self.status_bar)
        self.main_layout.addLayout(self.hbox)
        self.main_layout.addLayout(self.nigger)
