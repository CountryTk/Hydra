...
import platform
import random
from pypad.widgets.Messagebox import MessageBox, NewProject
from pypad.utils.config import config_reader, config_choice, LOCATION
from pypad.widgets.Tabs import Tabs
from pypad.utils.last_open_file import update_previous_file, get_last_file
from pypad.widgets.Content import Content
from pypad.widgets.Image import Image
from pypad.utils.find_utility import DocumentSearch
from pypad.widgets.Browser import Browser
from pypad.resources.materialblack import material_blue
from pypad.utils.check_update import show_update, make_decision
...
class Main(QMainWindow):
    ...
    def check_updates(self, text):
        ...
        self.update_label.setFont(QFont(self.editor["generalFont"], self.editor["generalFontSize"]))
        ...
        if text != "An update is available, would you like to update?":
            ...
            self.button.setFont(QFont(self.editor["generalFont"], self.editor["generalFontSize"]))
    ...
    def openFile(self, filename):
        ...
        try:
            ...
            if self.pic_opened is True:
                ...
                tab = Content(text, filename, basename, self)  # Creating a tab object *IMPORTANT*
                tab.saved = True
                tab.modified = False
